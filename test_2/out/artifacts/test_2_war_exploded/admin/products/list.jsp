							...
							<c:forEach items="${products}" var="p">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/products/edit.jsp?name=${p.name}&price=${p.price}&pnum=${p.pnum}&category=${p.category}&id=${p.id}&description=${p.description}">
